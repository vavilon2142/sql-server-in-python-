...
'''Здесь я использую созданную таблицу в MySQL для анализа данных. Я попросил покидать мне сложных задачек у друга который Data Analyst, вот что из этого получилось. 
